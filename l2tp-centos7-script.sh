...
*nat
:PREROUTING ACCEPT [271:21540]
:INPUT ACCEPT [7:564]
:OUTPUT ACCEPT [12:2880]
:POSTROUTING ACCEPT [0:0]
-A POSTROUTING -j MASQUERADE
-A POSTROUTING -s 10.0.1.0/24 -o eth0 -j MASQUERADE
-A POSTROUTING -s 10.0.1.0/24 -j SNAT --to-source 45.32.47.246
COMMIT
# Completed on Fri Jun 17 09:44:06 2016
# Generated by iptables-save v1.4.21 on Fri Jun 17 09:44:06 2016
*filter
:INPUT ACCEPT [0:0]
:FORWARD ACCEPT [0:0]
:OUTPUT ACCEPT [24:2208]
